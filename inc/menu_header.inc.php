...
<div id="header-wrapper">
	...
	<div id="menu">
			...
			if (!$qry) { die("Query Failed: " . mysqli_error($con)); }
			?>
			<ul>
			...
			<ul>
				<li><a href="/" data-rel="close" class="ui-btn">HOME</a></li></li>
				<li><a href="uns.php" class="ui-btn">&#220;BER UNS</a></li></li>
				<li><a href="services.php" class="ui-btn">SERVICES</a></li></li>
				<li><a href="referenzen.php" class="ui-btn">REFERENZEN</a></li></li>
				<li><a href="kontakt.php" class="ui-btn">KONTAKT</a></li></li>
			</ul>	
	</div>
</div>
</div>
