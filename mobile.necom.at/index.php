...
<div data-role="page" id="pageone">
  ...
  <div data-role="main" class="ui-content" style="min-height:400px; background-color:#71a6ee; text-align:center; color:#fff;">
		...
		<div class="boxA1">
			<p><img src="http://necom.at/images/first_banner/arbeit.png"></p>
			<h3>Unsere Arbeit</h3>
			<p>	Kundenzufriedenheit durch Flexibilit&auml;t und Qualit&auml;t. Wir sind nicht die einzigen, aber die beste.</p>
		</div>
		
		<div class="boxB1">
			<p><img src="http://necom.at/images/first_banner/zeit.png"></p>
		...
		<div class="boxC1">
			<p><img src="http://necom.at/images/first_banner/geschichte.png"></p>
			<h3>&Uuml;ber Uns</h3>
			<p>	Schritt f&uuml;r Schritt um die Welt, die Geschichte hat nur einen Namen "NECOM".</p>
		</div>
		
		<div class="boxD1">
			<p><img src="http://necom.at/images/first_banner/kontaktieren.png"></p>
