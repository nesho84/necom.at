...
<!--[if IE]><link rel="stylesheet" type="text/css" href="default_ie6.css.css" /><![endif]-->
...
<?php require ('./inc/menu_header.inc.php'); ?>
	...
	<h1> &#220;ber Uns </h1>
	<img src="images/abo.png">
	</div>

<div class="page_content_full">
<?php
	
	$qry1 = mysqli_query($con, "SELECT * FROM pages WHERE link='http://necom.at/uns'");
